...
window.TRANSLATIONS.en = {
  ...
  'חשב': 'Compute',
  'איפוס': 'Reset',
  'מבט מאחורי הצופה': 'View from behind the observer',
  'הצופה בראש הכדור, והמבט מאחוריו — השמש נראית מעליו כמו לעיניו': 'The observer at the top of the globe, viewed from behind — the Sun appears above them as it does to their eyes',
  ...
  'השורה שבראש האיור — המזל שהשמש עומדת בו ומעלתה בו (אורך המלקה של השמש, מחושב אסטרונומית). גררו את האיור לצדדים לסיבוב המבט סביב הציר, ומעלה ומטה להטיית הציר; "מבט מאחורי הצופה" מעמיד את הצופה בראש הכדור והמבט מאחוריו, והשמש נראית מעליו כשם שהיא נראית לעיניו. מחוון "שעה ביממה" מסובב את השמים, ומחוון היום מוליך את השמש במזלות. את הגלגל הנטוי כפי שהוא נראה מן הארץ רואים ב"מבט הצופה" שבלשונית גלגל המזלות.':
    'The line at the top of the picture gives the sign the Sun stands in and its degree within it (the Sun’s ecliptic longitude, computed astronomically). Drag the picture sideways to turn the view around the axis, and up and down to tilt the axis; “View from behind the observer” puts the observer at the top of the globe with the view from behind them, so the Sun appears above them just as it does to their eyes. The “Hour of day” slider turns the heavens, and the day slider carries the Sun through the signs. The tilted wheel as it appears from the Earth is shown in the “Observer view” of the Zodiac Wheel tab.',
