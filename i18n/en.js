...
window.TRANSLATIONS.en = {
  ...
  '"נטיית הקרניים לעין (מהאופק)" היא הנטייה כפי שרואה אותה הצופה: לאן פונות הקרניים (הפגימה) ביחס לזניט ולאופק — למעלה או למטה, וכמה מעלות הן סוטות מן הקו האנכי לצפון, לדרום, למזרח או למערב. היא שונה בהרבה מן הנטייה מקו המלקה, שכן קו המלקה עצמו נוטה לאופק לפי המקום, העונה והשעה. כשהפגימה פונה בעיקרה למעלה או למטה מצוינת בסוגריים הרוח שכנגדה היא פונה בלשון הרמב"ם (פי"ט הי"ב–הי"ד): הפגימה שפונה למעלה נמשכת דרך הזניט אל האופק שמנגד לירח, ולכן סהר השוקע במערב "פגימתו כנגד מזרח", השוקע בין מערב לצפון — "נוטה מכנגד מזרח כנגד דרום", ובין מערב לדרום — "כנגד צפון"; זו רוח האופק שמנגד, ולא הצד שאליו נוטות הקרניים מן הקו האנכי, שמארץ ישראל הוא בסהר הצעיר לעולם דרום (או ישר למעלה). הלשון "קרניים" נוהגת בסהר (פחות ממחצית מוארת); משהירח גיבן נקראת השורה "נטיית הפגימה", ובירח מלא היא נשמטת. חלה רק כשהירח מעל האופק.':
    '"Tilt of the horns to the eye (from the horizon)" is the tilt as the observer sees it: where the horns (the notch) point relative to the zenith and the horizon — upward or downward — and by how many degrees they lean from the vertical to the north, south, east or west. It differs greatly from the tilt from the ecliptic, since the ecliptic itself is inclined to the horizon by place, season and hour. When the notch points mainly upward or downward, the compass point it faces in Rambam’s language (ch. 19, 12–14) is given in parentheses: a notch facing upward continues through the zenith to the horizon opposite the Moon, so a crescent setting in the west has "its notch toward the east", one setting between west and north — "leaning from east toward south", and between west and south — "toward north"; this is the opposite horizon point, not the side toward which the horns lean from the vertical, which from the Land of Israel is always south (or straight up) for the young crescent. "Horns" is used for a crescent (less than half lit); once the Moon is gibbous the row is called "Tilt of the notch", and at full Moon it is omitted. Applies only while the Moon is above the horizon.',
