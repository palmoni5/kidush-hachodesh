...
window.TRANSLATIONS.en = {
  ...
  '"רוחב הירח" שלמעלה הוא נטייה זו במעלות לרגע המוצג: רוחב צפוני — כשהירח נוטה ממישור המלקה לעבר קוטב המלקה הצפוני, ורוחב דרומי — לעבר הקוטב הדרומי, כלשון הרמב"ם (הלכות קידוש החודש פט"ז ה"ב); ואין הרוחב לעולם יתר על חמש מעלות בקירוב. בשעת ליקוי הירח סמוך למישור המלקה, והרוחב קרוב לאפס.':
    '"Moon’s latitude" above is that tilt, in degrees, at the moment shown: a northern latitude — when the Moon tilts off the ecliptic plane toward the ecliptic’s north pole, and a southern latitude — toward the south pole, as the Rambam puts it (Hilchos Kiddush HaChodesh 16:2); and the latitude never exceeds about five degrees. During an eclipse the Moon is close to the ecliptic plane, and the latitude is near zero.',
