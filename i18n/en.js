...
window.TRANSLATIONS.en = {
  ...
  '"רוחב הירח" שלמעלה הוא נטייה זו במעלות לרגע המוצג: רוחב צפוני — כשהירח נוטה ממישור המלקה לעבר קוטב המלקה הצפוני, ורוחב דרומי — לעבר הקוטב הדרומי, כלשון הרמב"ם (הלכות קידוש החודש פט"ז ה"ט), שכתב שאין רוחב זה לעולם יתר על חמש מעלות; ובמפרש שם הובאה דעה שהוא קצת יותר, וכן הוא בחשבון האסטרונומי — עד כ-5.3 מעלות. בשעת ליקוי הירח סמוך למישור המלקה, והרוחב קרוב לאפס.':
    '"Moon’s latitude" above is that tilt, in degrees, at the moment shown: a northern latitude — when the Moon tilts off the ecliptic plane toward the ecliptic’s north pole, and a southern latitude — toward the south pole, as the Rambam puts it (Hilchos Kiddush HaChodesh 16:9), who wrote that this latitude never exceeds five degrees; the Meforash there cites a view that it is slightly more, and so it is in the astronomical reckoning — up to about 5.3°. During an eclipse the Moon is close to the ecliptic plane, and the latitude is near zero.',
