...
window.TRANSLATIONS.en = {
  ...
  'השורה שבראש האיור — המזל שהשמש עומדת בו ומעלתה בו (אורך המלקה של השמש, מחושב אסטרונומית). גררו את האיור לסיבוב המבט סביב הציר; מחוון "שעה ביממה" מסובב את השמים, ומחוון היום מוליך את השמש במזלות. את הגלגל הנטוי כפי שהוא נראה מן הארץ רואים ב"מבט הצופה" שבלשונית גלגל המזלות.':
    'The line at the top of the picture gives the sign the Sun stands in and its degree within it (the Sun’s ecliptic longitude, computed astronomically). Drag the picture to turn the view around the axis; the “Hour of day” slider turns the heavens, and the day slider carries the Sun through the signs. The tilted wheel as it appears from the Earth is shown in the “Observer view” of the Zodiac Wheel tab.',
  ...
  'כדור השמים סב סביב ציר הקטבים ממזרח למערב פעם ביממה · הנקודה האדומה — הצופה, והקו המקווקו — אופקו · גררו לסיבוב המבט':
    'The celestial sphere turns on the polar axis from east to west once a day · red dot — the observer, dashed circle — their horizon · drag to rotate the view',
