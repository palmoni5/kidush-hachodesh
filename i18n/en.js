...
window.TRANSLATIONS.en = {
  ...
  'לשמואל': 'per Shmuel',
  'שנה זו קודמת לתקנת הלל הנשיא (שנת ד׳קי״ט) — בזמן ההוא קידשו את החודשים על פי הראייה ועיברו את השנים בבית דין, והלוח שכאן אינו אלא החשבון הקבוע כשהוא נמשך לאחור.': 'This year is earlier than the enactment of Hillel HaNasi (the year 4119) — at that time the months were sanctified by sighting and the years intercalated by the beis din; the calendar here is only the fixed calculation carried backward.',
  'לרב אדא': 'per Rav Ada',
  'זמן ירושלים האמצעי': 'Jerusalem mean time',
  'ו-': 'and ',
  'אחרי התקופה האמיתית': 'after the true tekufah',
  'לפני התקופה האמיתית': 'before the true tekufah',
  'התקופה האמיתית (אסטרונומית)': 'True tekufah (astronomical)',
  'קפיצה לתקופת שמואל': 'Jump to Shmuel’s tekufah',
  'קפיצה לתקופת רב אדא': 'Jump to Rav Ada’s tekufah',
  'הלחצנים מעבירים את האיורים אל רגע התקופה לפי החשבון, בשנת החמה המוצגת; את התקופה האמיתית — בכרטיס "יום בשנה / עונה".': 'These buttons move the illustrations to the moment of the tekufah by the calculation, in the displayed solar year; the true tekufah is in the “Day of year / Season” card.',
  '▶ הפעל': '▶ Play',
  '⏸ השהה': '⏸ Pause',
  'מהירות:': 'Speed:',
  'ימים/שנייה': 'days/sec',
  ...
  'חשב': 'Compute',
  'איפוס': 'Reset',
  '👁 זנית הצופה למעלה': '👁 Observer’s zenith up', '↩ ציר הקטבים למעלה': '↩ Polar axis up',
  'הזנית של הצופה למעלה: אופקו מאוזן, ציר הקטבים נטוי כגובה הקוטב שברקיע (קו הרוחב), והשמש נראית מעל הארץ כמראה העין': 'The observer’s zenith upward: their horizon level, the polar axis tilted by the altitude of the pole in the sky (the latitude), and the Sun seen above the Earth as the eye sees it',
  ...
  'השעה בירושלים': 'Time in Jerusalem',
  'קו אורך': 'Longitude',
  'קו רוחב': 'Latitude',
  'אזור זמן': 'Time zone',
  'שעון קיץ': 'daylight time',
  'שעון רגיל': 'standard time',
  'זמנים — תאריך ושעה': 'Times — date and hour',
  'נתוני הירח': 'Moon data',
  'מיקום השמש': 'Sun position',
  'נתוני הזמן': 'Time data',
  'אורך היממה (משקיעה לשקיעה)': 'Full day (sunset to sunset)',
  'אורך הלילה': 'Night length',
  'שעה בשעון ישראל': 'Israel time',
  'מיקום השמש והמזלות': 'Sun and constellations',
  'עומק הליקוי': 'Eclipse depth',
  ...
  'קיבוץ = השמש והירח מתקבצים מצד אחד של הארץ ואין הירח נראה, וזהו זמן המולד (ובו באים ליקויי החמה). ניגוד = השמש והירח משני עברי הארץ, והוא ירח מלא (ובו באים ליקויי הלבנה). ג׳ ימים מן המולד — תחילת זמן ברכת הלבנה למנהג אשכנז, וז׳ ימים — למנהג הספרדים. האיור נועד להמחשת גודל הלבנה בלבד, אבל למעשה לענין תחילת זמן ברכת הלבנה וסופו מחשבים את זמני המולד לפי המולד האמצעי (חוץ מלאחר ליקוי לבנה שאין מברכין, כיון שניכר היה לעין כל שכבר היה הניגוד האמיתי) — ב״י סי׳ תכ״ו.':
    'Conjunction = the Sun and the Moon gather on one side of the Earth, and the Moon cannot be seen; this is the moment of the molad (and this is when solar eclipses happen). Opposition = the Sun and the Moon stand on opposite sides of the Earth, and the Moon is full (this is when lunar eclipses happen). Birkat HaLevanah may be said from three days after the molad by Ashkenazi custom, or from seven days by Sephardi custom. The illustration is meant only to show how large the Moon appears; in practice the start and end of the time for Birkat HaLevanah are reckoned from the mean molad (except after a lunar eclipse, when the blessing is not said, since it was plain to all that the true opposition had already passed) — Beit Yosef, Orach Chaim 426.',
  ...
  'נטיית הקרניים לעין (מהאופק)': 'Tilt of the horns to the eye (from the horizon)',
  'למעלה': 'upward', 'למטה': 'downward', 'כנגד': 'toward',
  'רוח הפגימה כלשון הרמב"ם (פי"ט)': 'Compass point of the notch in Rambam’s language (ch. 19)',
  'נטיית הפגימה לעין (מהאופק)': 'Tilt of the notch to the eye (from the horizon)',
  ...
  '"הירח מכדור הארץ" מצויר כמפת השמים: צפון המלקה למעלה ומזרח לשמאל, והקו המקווקו הקטן שבשוליו מסמן את כיוון השמש. כשהירח על מישור המלקה (רוחבו אפס) הקרניים מכוונות למזרח מדויק — ומן הניגוד ואילך למערב; כשרוחבו צפוני הן נוטות לצפון, וכשדרומי — לדרום, והנטייה ניכרת ביותר בסהר הצעיר הסמוך לשמש (וראו רמב"ם פי"ט). "רוחב הירח" שלמעלה הוא ערך זה.':
    '"The Moon as seen from Earth" is drawn like a sky map: ecliptic north up, east to the left, and the small dotted tick at its edge marks the direction of the Sun. When the Moon is on the ecliptic (latitude zero) the horns point exactly east — and west after opposition; when its latitude is north they tilt north, and when south, south — most noticeably in the young crescent close to the Sun (see Rambam ch. 19). "Moon’s latitude" above is this value.',
  '"נטיית הקרניים לעין (מהאופק)" היא הנטייה כפי שרואה אותה הצופה: לאן פונות הקרניים (הפגימה) ביחס לזניט ולאופק — למעלה או למטה, וכמה מעלות הן סוטות מן הקו האנכי לצפון, לדרום, למזרח או למערב. היא שונה בהרבה מנטיית הקרניים ביחס לקו המלקה שבחלון "הירח מכדור הארץ", שכן קו המלקה עצמו נוטה לאופק לפי המקום, העונה והשעה. שורת "רוח הפגימה כלשון הרמב"ם (פי"ט)" היא ענין אחר, בלשון פי"ט הי"ב–הי"ד: הפגימה שפונה למעלה נמשכת דרך הזניט אל האופק שמנגד לירח, ולכן סהר השוקע במערב "פגימתו כנגד מזרח", השוקע בין מערב לצפון — "נוטה מכנגד מזרח כנגד דרום", ובין מערב לדרום — "כנגד צפון"; ובכלל: מושכים את כיוון הפגימה על פני הכיפה עד האופק, ורוח האופק שם היא רוח הפגימה. זו רוח האופק, ולא הצד שאליו נשענות הקרניים מן הקו האנכי שבשורת הנטייה לעין — שמארץ ישראל הוא בסהר הצעיר לעולם דרום (או ישר למעלה); ולכן אין סתירה בין "כנגד מזרח" ובין "למעלה · 42° לדרום" באותו רגע: הראשון רוח האופק שאליו מגיעה הפגימה, והשני הצד שאליו היא נשענת בתמונה. הלשון "קרניים" נוהגת בסהר (פחות ממחצית מוארת); משהירח גיבן נקראת השורה "נטיית הפגימה", ובירח מלא היא נשמטת. בשורת הנטייה לעין, כשהקרניים פונות בעיקרן למעלה או למטה, מצוינת בסוגריים רוח האופק שאליה מוליך ה"למעלה" — האופק שמנגד לירח (ולמטה — האופק שתחתיו): "למעלה (כנגד מזרח) · 20° לדרום", שכך לשון העדות: הרוח שכנגדה, ועמה הנשיאה לצפון או לדרום. ציון זה עומד בפני עצמו ואינו תלוי בפירוש דברי הרמב"ם שבשורה שאחריה; בירח נמוך השניים שווים, ובירח גבוה שקרניו נשואות הצידה עשויה שורת הרמב"ם להיות מוסטת. ביום, כשהחמה זורחת והלבנה אינה נראית לעין, שתי השורות נשמטות — שאין בהן צורך אלא לחקירת העדים. חלה רק כשהירח מעל האופק.':
    '"Tilt of the horns to the eye (from the horizon)" is the tilt as the observer sees it: where the horns (the notch) point relative to the zenith and the horizon — upward or downward — and by how many degrees they lean from the vertical to the north, south, east or west. It differs greatly from the tilt of the horns relative to the ecliptic in "The Moon as seen from Earth", since the ecliptic itself is inclined to the horizon by place, season and hour. The row "Compass point of the notch in Rambam’s language (ch. 19)" is a separate matter, in the language of ch. 19, 12–14: a notch facing upward continues through the zenith to the horizon opposite the Moon, so a crescent setting in the west has "its notch toward the east", one setting between west and north — "leaning from east toward south", and between west and south — "toward north"; in general, the notch’s direction is followed across the dome to the horizon, and the compass point there is the notch’s direction. This is a horizon point, not the side toward which the horns lean from the vertical in the eye-tilt row — which from the Land of Israel is always south (or straight up) for the young crescent; so there is no contradiction between "toward east" and "upward · 42° to the south" at the same moment: the first is the horizon point the notch reaches, the second the side it leans to in the picture. "Horns" is used for a crescent (less than half lit); once the Moon is gibbous the row is called "Tilt of the notch", and at full Moon it is omitted. In the eye-tilt row, when the horns point mainly upward or downward, the parentheses give the horizon point that "upward" leads to — the horizon opposite the Moon (and for downward, the horizon beneath it): "upward (toward east) · 20° to the south", as the testimony is phrased: the point opposite, together with the lean to the north or south. This stands on its own and does not depend on the reading of Rambam in the next row; for a low Moon the two agree, and for a high Moon whose horns lean sideways Rambam’s row may be shifted. By day, when the Sun is up and the Moon cannot be seen, both rows are omitted — they matter only for questioning the witnesses. Applies only while the Moon is above the horizon.',
  ...
  'הארץ בתוך כדור השמים, במבט מבחוץ, כתמונת חז״ל והרמב״ם: הארץ עומדת במרכז, כדור השמים סובב סביבה על ציר הקטבים ממזרח למערב פעם ביממה, והשמש נודדת בגלגל המזלות הנטוי ממזל למזל ממערב למזרח — חציו צפונה וחציו דרומה ממשווה השמים. הפקדים ולוח הנתונים משותפים לשלוש החלוניות.':
    'Earth inside the celestial sphere, seen from outside, as Chazal and the Rambam picture it: the Earth stands at the center, the sphere of the heavens turns around it on the polar axis from east to west once a day, and the Sun wanders along the tilted zodiac wheel from sign to sign, from west to east — half of it north of the celestial equator and half south. The controls and the data panel are shared by all three views.',
  'הגלגל הנטוי — כדרך חז״ל והרמב״ם': 'The tilted wheel — as Chazal and the Rambam describe it',
  'מבט מבחוץ על הארץ בתוך כדור השמים, כתמונת חז״ל והרמב״ם: הארץ עומדת במרכז, וכדור השמים כולו סובב סביבה על ציר הקטבים ממזרח למערב פעם ביממה — ועמו השמש והמזלות. השמש עצמה מהלכת בגלגל הנוטה — גלגל המזלות — שחציו נוטה צפונה וחציו דרומה ממשווה השמים, ועוברת בו ממזל למזל עד שמשלימה סיבובה בשנה. הנקודה האדומה היא מקום הצופה על הארץ, הקו המקווקו האדום עולה ממנו אל הזנית שמעליו ברקיע, והעיגול המקווקו הגדול הוא אופקו — כל שמעליו נראה לו, כבכיפת הרקיע.':
    'A view from outside of the Earth inside the celestial sphere, as Chazal and the Rambam picture it. The Earth stands at the center, and the whole sphere of the heavens turns around it on the polar axis from east to west once a day, carrying the Sun and the signs with it. The Sun itself travels along the tilted wheel — the zodiac — half of which leans north of the celestial equator and half south, passing from sign to sign until it completes its round in a year. The red dot is the observer’s place on the Earth, the dashed red line rises from it to the zenith above them in the sky, and the large dashed circle is their horizon — everything above it is visible to them, as in the sky dome.',
  'מפני שהגלגל נטוי, נודד מסלולה היומי של השמש: כשהיא בראש מזל סרטן (תקופת תמוז) היא בקצהו הצפוני של הגלגל, ומסלולה היומי הוא החוג הצפוני, 23.44° ממשווה השמים; בראש גדי (תקופת טבת) היא בקצהו הדרומי; ובראש טלה ומאזניים (תקופות ניסן ותשרי) היא על משווה השמים עצמו. זו הנדידה שרואים בכיפת הרקיע, ואותה נטייה ממש היא נטיית ציר הארץ שבחלונית "נטיית כדור הארץ": שם הצופה עומד מבחוץ בחלל והארץ סובבת, וכאן הוא עומד עם הארץ והשמים סובבים סביבה. אין כאן שתי מציאויות אלא אחת משתי זוויות, ולוח הנתונים המשותף מראה אותם ערכים בשלוש החלוניות.':
    'Because the wheel is tilted, the Sun’s daily path wanders. When the Sun is at the head of Cancer (Tekufas Tammuz) it is at the northern end of the wheel, and its daily path is the northern circle, 23.44° from the celestial equator. At the head of Capricorn (Tekufas Teves) it is at the southern end, and at the head of Aries and Libra (the tekufos of Nissan and Tishrei) it is on the celestial equator itself. This is the drift seen in the sky dome, and this very tilt is the tilt of Earth’s axis in the “Earth’s tilt” view: there the viewer stands outside in space and the Earth turns, here they stand with the Earth and the heavens turn around it. These are not two realities but one, from two angles, and the shared data panel shows the same values in all three views.',
  'השורה שבראש האיור — המזל שהשמש עומדת בו ומעלתה בו (אורך המלקה של השמש, מחושב אסטרונומית). גררו את האיור לצדדים לסיבוב המבט סביב הציר, ומעלה ומטה להטיית המבט; "זנית הצופה למעלה" מגלגל את המבט כך שהזנית של הצופה פונה למעלה — אופקו מאוזן, ציר הקטבים נטוי על המסך כגובה הקוטב שברקיע, שהוא קו הרוחב (בקו המשווה הציר מאוזן ממש והקטבים באופק, בירושלים נטוי כ-32°, ובקוטב זקוף), והשמש שמעל האופק עומדת מעל הארץ כמראה העין. מחוון "שעה ביממה" מסובב את השמים, ומחוון היום מוליך את השמש במזלות. את הגלגל הנטוי כפי שהוא נראה מן הארץ רואים ב"מבט הצופה" שבלשונית גלגל המזלות.':
    'The line at the top of the picture gives the sign the Sun stands in and its degree within it (the Sun’s ecliptic longitude, computed astronomically). Drag the picture sideways to turn the view around the axis, and up and down to raise or lower it; “Observer’s zenith up” rolls the view so that the observer’s zenith points upward — their horizon is level, the polar axis is tilted on the screen by the altitude of the pole in the sky, which equals the latitude (at the equator the axis is fully level with the poles on the horizon, in Jerusalem it is tilted about 32°, and at the pole it stands upright), and the Sun above the horizon stands above the Earth as the eye sees it. The “Hour of day” slider turns the heavens, and the day slider carries the Sun through the signs. The tilted wheel as it appears from the Earth is shown in the “Observer view” of the Zodiac Wheel tab.',
  'ואותה נטייה כתמונת חז״ל והרמב״ם — הארץ עומדת במרכז וכדור השמים סובב סביבה, והשמש מהלכת בו בגלגל הנוטה — רואים בחלונית "הגלגל הנטוי".':
    'The same tilt as Chazal and the Rambam picture it — the Earth standing at the center with the sphere of the heavens turning around it, and the Sun traveling on the tilted wheel — is shown in the “Tilted wheel” view.',
  'כדור השמים סב סביב ציר הקטבים ממזרח למערב פעם ביממה · הנקודה האדומה — הצופה, והקו המקווקו — אופקו · גררו לסיבוב המבט ולהטיית הציר':
    'The celestial sphere turns on the polar axis from east to west once a day · red dot — the observer, dashed circle — their horizon · drag to rotate the view and tilt the axis',
  ...
  'הארץ במסלולה סביב השמש, במבט מן הצד: ציר סיבובה נטוי 23.44° וכיוונו קבוע בחלל, ולכן בתמוז השמש עומדת מעל קו ההיפוך הצפוני ובטבת מעל הדרומי. הקו האדום הוא קו האורך של הצופה והנקודה שעליו מקומו — ושניהם מקיפים את הציר פעם ביממה. הפקדים ולוח הנתונים משותפים לשלוש החלוניות.':
  ...
  'האיור מציג שנת חמה אחת — מתקופת ניסן (שוויון האביב) ועד הבאה, והתאריך שנבחר קובע איזו מהן. השנים 1000–3000; התאריכים בלוח הגרגוריאני, ואף לשנים שקודם שנהג (1582). בשנים רחוקות מזמננו דיוק החישוב פוחת, בעיקר מחמת אי-הוודאות בקצב סיבוב הארץ.':
    'The diagram shows one solar year — from Tekufas Nissan (the spring equinox) to the next; the date you pick decides which one. Years 1000–3000; dates are in the Gregorian calendar, even for years before it came into use (1582). The further a year is from our time, the less exact the calculation, mainly because of uncertainty in the Earth’s rotation rate.',
  ...
  'ואף שתקופות ניסן ותשרי נקראות "שוויון", היום שבו "אורך היום" שבלוח שווה ללילה אינו יום התקופה עצמו אלא כמה ימים לפני תקופת ניסן וכמה ימים אחרי תקופת תשרי (בירושלים כשלושה–ארבעה ימים). התקופה היא הרגע שמרכז השמש על קו המשווה, ובו היום הגאומטרי שווה ללילה; אבל הזריחה והשקיעה שבלוח, ושרואים בעין, הן של קצה השמש העליון, והאטמוספרה עוד מרימה את השמש הנמוכה בכחצי מעלה — וכך ביום התקופה היום הנראה ארוך מן הלילה בכ-13 דקות בירושלים, ויותר ככל שהמקום צפוני. ואף הרמב"ם (פ"ט ה"ג) מגדיר את התקופה בכניסת השמש לראש מזל טלה, ולא ביום השווה.':
    'Although the Nisan and Tishrei tekufot are called "equinox", the day on which "Day length" in the panel equals the night is not the tekufah itself but a few days before the Nisan tekufah and a few days after the Tishrei one (about three to four days in Jerusalem). The tekufah is the moment the Sun’s center is on the celestial equator, when the geometric day equals the night; but the sunrise and sunset in the panel, and those seen by the eye, are of the Sun’s upper limb, and the atmosphere further lifts the low Sun by about half a degree — so on the tekufah day the visible day is longer than the night by about 13 minutes in Jerusalem, and more the farther north the place. Rambam too (9:3) defines the tekufah by the Sun’s entry into the head of Aries, not by the day of equal length.',
  'שלוש קבוצות לחצנים: התקופה האמיתית (בכרטיס "יום בשנה / עונה") — רגע השוויון או ההיפוך, המחושב אסטרונומית; ותקופת שמואל ותקופת רב אדא — שהן חשבון "בקירוב... ובמהלך השמש האמצעי לא במקומה האמיתי" (רמב״ם קידוש החודש פ״י ה״ז). שתיהן נמנות מן המולדות: תקופת ניסן של שמואל בשנת היצירה קודם מולד ניסן בז׳ ימים ט׳ שעות ותרמ״ב חלקים (שם פ״ט ה״ג), ושל רב אדא בכל שנה ראשונה של מחזור קודם מולד ניסן בט׳ שעות ותרמ״ב חלקים (שם פ״י ה״ג); ושעותיהן נקראות כזמן ירושלים האמצעי, כמולדות. שנת שמואל ארוכה משל רב אדא כארבע דקות וחצי (שעה ותפ״ה חלקים במחזור), ולכן הן מתרחקות זו מזו כיום אחד בכל כ-315 שנה: בזמננו תקופת שמואל מאוחרת מן האמיתית כשמונה-עשר יום, ושל רב אדא כשבעה ימים.':
    'Three sets of buttons: the true tekufah (in the “Day of year / Season” card) — the moment of the equinox or solstice, worked out astronomically; and the tekufah of Shmuel and of Rav Ada — which are reckonings made “approximately… by the mean course of the Sun, not its true place” (Rambam, Kiddush HaChodesh 10:7). Both are counted from the molados: Shmuel’s Tekufas Nissan in the year of Creation came 7 days, 9 hours and 642 chalakim before Molad Nissan (ibid. 9:3), and Rav Ada’s, in the first year of every cycle, 9 hours and 642 chalakim before Molad Nissan (ibid. 10:3); their hours are read as Jerusalem mean time, like the molados. Shmuel’s year is about four and a half minutes longer than Rav Ada’s (1 hour 485 chalakim per cycle), so they drift apart by about a day every 315 years: in our time Shmuel’s tekufah falls about eighteen days after the true one, and Rav Ada’s about seven days after.',
  'ובחשבון האסטרונומי אין תקופה שוה באורכה לחברתה, שאין הארץ מהלכת במסלולה בקצב אחיד: בתחילת ינואר (בתוך תקופת טבת) היא בקרבתה הגדולה אל השמש ומהלכה מהיר, ולכן תקופות תשרי וטבת קצרות ותקופות ניסן ותמוז ארוכות (רמב״ם קדוה״ח פ״י ה״ז). אורך התקופות האמיתיות בזמננו (והוא משתנה מעט משנה לשנה ובמהלך הדורות):':
    'In the astronomical reckoning no tekufah equals another in length, because the Earth does not move along its orbit at a uniform pace: in early January (within Tekufas Teves) it is nearest the Sun and moves fastest, so Tekufos Tishrei and Teves are short while Nissan and Tammuz are long (Rambam, Kiddush HaChodesh 10:7). The true lengths in our era (they vary slightly from year to year and over the generations):',
  ...
  'נטיית הגלגל לאופק הצופה': 'Tilt of the wheel to the observer’s horizon',
  'הנקודה הגבוהה בגלגל': 'Highest point of the wheel',
  'נוטה אל': 'leaning',
  'גובה': 'altitude',
  '"נטיית הגלגל לאופק הצופה" שבלוח הנתונים היא הזווית שבין מישור גלגל המזלות למישור האופק באותו רגע. משווה השמים נטוי לאופק בזווית קבועה — 90° פחות קו הרוחב (בירושלים 58.2°) — אבל הגלגל אינו מקביל למשווה אלא נטוי עליו 23.44°, ולכן נטייתו לאופק משתנה במשך היממה: כשהוא נוטה מן המשווה אל צד האופק היא קטנה — עד 34.8° בירושלים — וכשהוא נוטה אל הצד שכנגד היא גדולה, עד 81.7°; והזווית עצמה היא גם גובה הנקודה הגבוהה שברצועה מעל האופק, שהיא לעולם 90° לפני המזל העולה, וכיוונה באופק הוא הצד שאליו הגלגל נוטה. במבט־על אין הנטייה ניכרת, שהוא מפה של הגלגל ולא של הרקיע; ראו אותה ב"מבט הצופה".':
    '"Tilt of the wheel to the observer’s horizon" in the data panel is the angle between the plane of the zodiac and the plane of the horizon at that moment. The celestial equator is tilted to the horizon by a fixed angle — 90° minus the latitude (58.2° in Jerusalem) — but the wheel is not parallel to the equator; it is tilted 23.44° to it, so its tilt to the horizon changes through the day. When it leans from the equator toward the horizon the angle is small — down to 34.8° in Jerusalem — and when it leans the other way it is large, up to 81.7°. That angle is also the altitude of the highest point of the band above the horizon, which is always 90° ahead of the ascendant, and its compass direction is the side toward which the wheel leans. In the top-down view the tilt cannot be seen, since that view is a map of the wheel and not of the sky; see it in the "Observer view".',
  ...
  'מבט־על': 'Top-down', 'הגלגל מלמעלה': 'the wheel from above',
  'מבט הצופה': 'Observer view',
  'מבט מבחוץ': 'Outside view', 'הארץ והשמש': 'Earth and Sun',
  ...
  'כאן נראה הירח': 'The Moon is seen here',
  ...
  'ובמבט מבחוץ אתם יוצאים אל מחוץ למערכת כולה ורואים את שלושתם כאחד — המזלות, השמש והארץ. וכאן מתבאר מה מסובב את הגלגל: המזלות עומדים ואינם נעים כלל; הארץ סובבת סביב עצמה פעם ביממה, וזהו הסיבוב היומי של הגלגל כולו, שבשני המבטים האחרים נראה כאילו הרקיע הוא הסובב; והארץ מקיפה את השמש פעם בשנה, ומכאן נדידת השמש בין המזלות. הקו האדום שעל הארץ הוא מקומו של הצופה, והקו הצהוב הוא קו הראייה מן הארץ דרך השמש אל הרצועה — והוא הנותן את התשובה באיזה מזל השמש עומדת. בחרו "ימים" והפעילו לראות את מהלך השנה, או "שעות" לראות את הסיבוב היומי. שמות ארבע התקופות רשומים אצל המזלות שהשמש נראית בהם — ניסן בראש טלה, תמוז בסרטן, תשרי במאזניים וטבת בגדי — והנקודות שעל מסלול הארץ, שכנגדם, הן מקום הארץ באותן תקופות: היא עומדת לעולם במזל שכנגד השמש.':
    'In the outside view you step outside the whole system and see all three of them together — the signs, the Sun and the Earth. Here you can see what is turning the wheel. The signs stand still; they do not move at all. The Earth spins once a day, and that spin is the daily turning of the whole wheel, which in the other two views looks as though the sky itself were going round. And the Earth circles the Sun once a year, which is why the Sun drifts from sign to sign. The red line on the Earth is where the observer is standing, and the yellow line is the line of sight from the Earth through the Sun out to the band — that is what answers the question which sign the Sun is in. Choose “Days” and press Play to watch the year go by, or “Hours” to watch the daily spin. The names of the four tekufos are written by the signs the Sun is seen in then — Nissan at the head of Aries, Tammuz in Cancer, Tishrei in Libra and Teves in Capricorn — and the dots on the Earth’s orbit, opposite them, are where the Earth is at those tekufos: it always stands in the sign opposite the Sun.',
  'ומכאן הטעם למה שנתבאר במבט־על, שהמזלות קבועים והשמש היא הנודדת ביניהם: בתקופת תמוז עומדת הארץ בצד גדי, ונמצאת השמש נראית מנגד — בראש סרטן; ובתקופת טבת להפך. ואין הציור קנה מידה כלל — המזלות רחוקים לאין ערוך ממסלול הארץ, ורק הכיוונים שבו אמיתיים; ומשום כך נמתח קו הראייה מן הארץ דרך השמש עצמה, שכך הוא מכוון בכל מקום שבמסלול. אף מרחק הירח מן הארץ מוגדל הרבה כדי שייראה, וכיוונו ומופעו אמיתיים. והקו התכול הוא קו הראייה מן הארץ אל המזל שהירח נראה בו; ומפני שמרחק הירח מוגדל, הקו מכוון אל מזלו האמיתי ואינו עובר דרך הירח המצויר ממש אלא סמוך למולד ולמילוי.':
    'This is the reason for what was said in the top-down view, that the signs are fixed and it is the Sun that wanders among them. At Tekufas Tammuz the Earth stands over on the Capricorn side, so the Sun is seen from it in the opposite direction — at the head of Cancer; at Tekufas Teves it is the other way round. The drawing is nowhere near to scale. The signs are immeasurably farther away than the Earth’s orbit, and only the directions in the picture are true. That is why the line of sight is drawn from the Earth through the Sun itself, so that it points correctly wherever the Earth stands in its orbit. The Moon’s distance from the Earth is greatly enlarged as well, so that it can be seen; its direction and its phase are true. The light-blue line is the line of sight from the Earth to the sign the Moon is seen in. Because the Moon’s distance is enlarged, the line points to the Moon’s true sign, and it passes exactly through the drawn Moon only near the new moon and the full moon.',
  'מבט אל': 'Facing',
