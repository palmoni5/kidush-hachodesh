...
window.TRANSLATIONS.en = {
  ...
  '"נטיית הקרניים לעין (מהאופק)" היא הנטייה כפי שרואה אותה הצופה: לאן פונות הקרניים ביחס לזניט ולאופק, למעלה או למטה וכמה מעלות לצפון, לדרום, למזרח או למערב. היא שונה בהרבה מן הנטייה מקו המלקה, שכן קו המלקה עצמו נוטה לאופק לפי המקום, העונה והשעה — קרניים המכוונות לאורך המלקה כמעט בלא נטייה יכולות להיראות לעין מוטות בחדות למעלה ולדרום. השורה חלה רק כשהירח מעל האופק.':
    '"Tilt of the horns to the eye (from the horizon)" is the tilt as the observer sees it: where the horns point relative to the zenith and the horizon — upward or downward, and by how many degrees to the north, south, east or west. It differs greatly from the tilt from the ecliptic, since the ecliptic itself is inclined to the horizon by place, season and hour — horns pointing along the ecliptic with almost no tilt can appear to the eye sharply tilted upward and to the south. The row applies only while the Moon is above the horizon.',
